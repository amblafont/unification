...
\DeclareUnicodeMathCharacter{FE54}{;}
...
\ExecuteMetaData[\agdalatexdir/lcsig.tex]{#1}%
...
% {#2}%
%   }}}
% \begin{proof}[Alternative text] does not work with jfp
\newenvironment{proofWithAlternative}[1][Proof]{\par\addvspace{6pt}\noindent\textbf{#1}\hskip5.5pt}{\hfill$\blacksquare$\par\addvspace{6pt}}
